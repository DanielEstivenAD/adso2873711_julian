...
class Gato extends Animal {
  String _raza;
  String _idMascosta;
  Gato(String _nombre, DateTime _fechaNac, this._raza, double _peso,
      String _color, bool _esterilizado, this. _idMascosta)
      : super(_nombre, _fechaNac, _peso, _color, _esterilizado);
  String getRaza() {
    return _raza;
  }
  ...
  void setIdMascota( String newIdMascosta){
    ...
    print('ID de Mascota: $_idMascosta');
  }  
}
